...
export const clientNewsletter = {
  ...
  newsletter:
    "I’m interested in learning more about joining the HealGuid Partner Network.",
...
export const partnerNewsletter = {
  ...
  description:
    "Join our Founding Partners Program, and be part of transforming holistic healthcare delivery.",
...
export const footer = {
  newsletter: {
    ...
    description:
      "Be the first to know about our launch and get exclusive updates:",
    privacyPolicy:
      "By clicking you accept you agree to receive updates and accept our Privacy Policy",
  },
  links: [
    {
      id: "0",
...
export const aboutUs = {
  ...
  endInfo: {
    ...
    altStart:
      "People climbing steps with gears, symbolizing progress and collaboration in holistic healthcare.",
